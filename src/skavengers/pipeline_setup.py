...
# Function to search for substring in list
    ...
    def gen_par_files(self, config):
        template_file = f'{config_path}/{template_file}'
    ...
    #TODO Add RAM and region size calculations
        ...
        for z in range(number_of_slices):
            ...
            output_filename = '{0}_{1:03d}'.format(output_db_name, z)
    ...
    #
            ...
            filename = "{0}/sofia_{1:03d}.par".format(config_path, z);
            sys.stdout.write("  {0}\n".format(filename));
            try:
            ...
            return_sofia_parms.append(SofiaParams(filename, output_filename))
            
        return return_sofia_parms
